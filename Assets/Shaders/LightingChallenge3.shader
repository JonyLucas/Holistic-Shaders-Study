Shader "Holistic/LightingChallenge3"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        float4 LightingToonRamp (SurfaceOutput s, float3 lightDir,float3 viewDir, float atten) {
            float diffuse = dot (s.Normal, viewDir);
